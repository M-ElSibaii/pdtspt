            ...
            <div class="grid grid-cols-1 gap-6">
                ...
                <div class="border border-gray-200 rounded-lg p-4 flex items-center">
                    ...
                    <div>
                        ...
                        <p class="text-gray-500 text-sm">Date: 09/05/2024</p>
                    </div>
                </div>
                ...
                <div class="border border-gray-200 rounded-lg p-4 flex items-center">
                    ...
                    <div>
                        ...
                        <p><strong>Autores:</strong> Mohamad El Sibaii, Débora Pinto, Luís Sanhudo, João Poças Martins, Hugo Patrício, José Granja, Miguel Azenha</p>
                        <p class="text-gray-500 text-sm">Date: 09/05/2024</p>
                    </div>
                </div>
                ...
                <div class="border border-gray-200 rounded-lg p-4 flex items-center">
                    ...
                    <div>
                        ...
                        <p><strong>Autores:</strong> Artur Kuzminykh, Achushankar Anil, Vasco Vieira, Manuel Parente, José Granja, Miguel Azenha</p>
                        <p class="text-gray-500 text-sm">Date: 09/05/2024</p>
                    </div>
                </div>
                ...
                <div class="border border-gray-200 rounded-lg p-4 flex items-center">
                    ...
                    <div>
                        ...
                        <p><strong>Autores:</strong> Mohamad El Sibaii, Renan Rocha Ribeiro, Ricardo Dias, José Rui Pinto, José Granja, Miguel Azenha</p>
                        <p class="text-gray-500 text-sm">Date: 11/06/2023</p>
                    </div>
                </div>
                ...
                <div class="border border-gray-200 rounded-lg p-4 flex items-center">
                    ...
                    <div>
                        ...
                        <p><strong>Autores:</strong> Mohamad El Sibaii, José Granja, Renan Rocha Ribeiro, Pedro Meda, Ricardo Pontes Resende, João dos Santos, Pedro Lucas Martins, António Aguiar Costa, João Poças Martins, Miguel Azenha</p>
                        <p class="text-gray-500 text-sm">Date: 04/05/2022</p>
                    </div>
                </div>
                ...
                <div class="border border-gray-200 rounded-lg p-4 flex items-center">
                    ...
                    <div>
                        ...
                        <p><strong>Autores:</strong> Mohamad El Sibaii, José Granja, Luis Bidarra, Miguel Azenha</p>
                        <p class="text-gray-500 text-sm">Date: 04/04/2022</p>
                    </div>
                </div>
