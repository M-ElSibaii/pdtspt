<x-app-layout>
    <div style="background-color: white;">
        <div class="container sm:max-w-full py-9">
            ...
            <h1>{{ Lg::pick('Conhecimento', 'Knowledge') }}</h1>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="border border-gray-200 rounded-lg p-4">
                    ...
                    <p class="text-gray-500 text-sm mt-2">{{ Lg::pick('Data:', 'Date:') }} 09/05/2024</p>
                </div>

                <div class="border border-gray-200 rounded-lg p-4">
                    <a href="img/5ptBIMDPPPDTworkshop2024.pdf" download>
                        <img src="img/dpppdtsworkshopptbim5.png" alt="Publication Thumbnail" class="w-full h-auto rounded-lg">
                    </a>
                    <a href="img/5ptBIMDPPPDTworkshop2024.pdf" download class="text-xl font-semibold mt-4 block">A apresentação de Passaportes Digitais De Produtos E A Iniciativa PDTs.pt, Workshop Da 5ª Edição Do ptBIM 2024
                    </a>
                    <p class="text-gray-500 text-sm mt-2">{{ Lg::pick('Data:', 'Date:') }} 09/05/2024</p>
                </div>
                  ...
                  <div class="border border-gray-200 rounded-lg p-4">
                    ...
                    <p class="text-gray-500 text-sm mt-2">{{ Lg::pick('Data:', 'Date:') }} 04/05/2026</p>
                </div>
        ...
        <div class="container sm:max-w-full py-9">
            ...
            <h1>{{ Lg::pick('Publicações científicas', 'Scientific publications') }}</h1>
            ...
            <div class="grid grid-cols-1 gap-6">
                <!-- Publication Containers -->
                   ...
                   <div class="border border-gray-200 rounded-lg p-4 flex items-center">
                    ...
                    <div>
                        ...
                        <p><strong>{{ Lg::pick('Autores:', 'Authors:') }}</strong> Mohamad El Sibaii, José Granja, Miguel Azenha</p>
                        <p class="text-gray-500 text-sm">{{ Lg::pick('Data:', 'Date:') }} 01/05/2025</p>
                    </div>
                </div>
                ...
                <div class="border border-gray-200 rounded-lg p-4 flex items-center">
                    ...
                    <div>
                        ...
                        <p><strong>{{ Lg::pick('Autores:', 'Authors:') }}</strong> Mohamad El Sibaii, José Granja, Miguel Azenha</p>
                        <p class="text-gray-500 text-sm">{{ Lg::pick('Data:', 'Date:') }} 09/05/2024</p>
                    </div>
                </div>
                ...
                <div class="border border-gray-200 rounded-lg p-4 flex items-center">
                    ...
                    <div>
                        ...
                        <p><strong>{{ Lg::pick('Autores:', 'Authors:') }}</strong> Mohamad El Sibaii, Débora Pinto, Luís Sanhudo, João Poças Martins, Hugo Patrício, José Granja, Miguel Azenha</p>
                        <p class="text-gray-500 text-sm">{{ Lg::pick('Data:', 'Date:') }} 09/05/2024</p>
                    </div>
                </div>
                ...
                <div class="border border-gray-200 rounded-lg p-4 flex items-center">
                    ...
                    <div>
                        ...
                        <p><strong>{{ Lg::pick('Autores:', 'Authors:') }}</strong> Artur Kuzminykh, Achushankar Anil, Vasco Vieira, Manuel Parente, José Granja, Miguel Azenha</p>
                        <p class="text-gray-500 text-sm">{{ Lg::pick('Data:', 'Date:') }} 09/05/2024</p>
                    </div>
                </div>
                ...
                <div class="border border-gray-200 rounded-lg p-4 flex items-center">
                    ...
                    <div>
                        ...
                        <p><strong>{{ Lg::pick('Autores:', 'Authors:') }}</strong> Mohamad El Sibaii, Renan Rocha Ribeiro, Ricardo Dias, José Rui Pinto, José Granja, Miguel Azenha</p>
                        <p class="text-gray-500 text-sm">{{ Lg::pick('Data:', 'Date:') }} 11/06/2023</p>
                    </div>
                </div>
                ...
                <div class="border border-gray-200 rounded-lg p-4 flex items-center">
                    ...
                    <div>
                        ...
                        <p><strong>{{ Lg::pick('Autores:', 'Authors:') }}</strong> Mohamad El Sibaii, José Granja, Renan Rocha Ribeiro, Pedro Meda, Ricardo Pontes Resende, João dos Santos, Pedro Lucas Martins, António Aguiar Costa, João Poças Martins, Miguel Azenha</p>
                        <p class="text-gray-500 text-sm">{{ Lg::pick('Data:', 'Date:') }} 04/05/2022</p>
                    </div>
                </div>
                ...
                <div class="border border-gray-200 rounded-lg p-4 flex items-center">
                    ...
                    <div>
                        ...
                        <p><strong>{{ Lg::pick('Autores:', 'Authors:') }}</strong> Mohamad El Sibaii, José Granja, Luis Bidarra, Miguel Azenha</p>
                        <p class="text-gray-500 text-sm">{{ Lg::pick('Data:', 'Date:') }} 04/04/2022</p>
                    </div>
                </div>
                ...
                <div class="border border-gray-200 rounded-lg p-4 flex items-center">
                    ...
                    <div>
                        ...
                        <p><strong>{{ Lg::pick('Autores:', 'Authors:') }}</strong> Mohamad El Sibaii, Cátia Marques, Luis Bidarra, Miguel Azenha</p>
                        <p class="text-gray-500 text-sm">{{ Lg::pick('Data:', 'Date:') }} 26/11/2020</p>
                    </div>
                </div>
                <!-- Add more publication containers as necessary -->
            </div>
        </div>
    </div>
</x-app-layout>