<x-app-layout>
    <div style="background-color: white;">
        <div class="container py-9">
            ...
            <h2 class="mb-4">Obter Template de Dados de Produtos</h2>
            ...
            <h2 class="mb-4">Obter Todos os Modelos de Dados de Produtos</h2>
            <p class="mb-4">Retorna todos os templates de dados de produtos.</p>
            <div style="background-color: #F0F4F8;">
                <pre><code>GET /api/productDataTemplates</code></pre>
            </div>
            <h2 class="mb-4">Obter Conteúdo do Dicionário de Dados</h2>
            ...
            <h2 class="mb-4">Obter Documentos de Referência</h2>
            ...
            <h2 class="mb-4">Obter Grupos de Propriedades</h2>
