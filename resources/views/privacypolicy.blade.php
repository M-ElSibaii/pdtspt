<x-app-layout>
    <div style="background-color: white;">
        <div class="container py-9">
            ...
            <h2>Âmbito</h2>
            <p>A Política de Privacidade aplica-se aos dados recolhidos e tratados pela BuildingSMART Portugal no exercício das suas atividades, designadamente através do website e area reservada para associados.</p>

            <h2>Dados Pessoais</h2>
            <p>Consideram-se «dados pessoais» qualquer informação relativa a uma pessoa singular identificada ou identificável. Por seu turno, é considerada identificável a pessoa singular suscetível de ser identificada, direta ou indiretamente, especialmente através de um referenciador como seja o nome, dados de localização, elementos específicos da integridade física, fisiológica, etc.</p>

            <p>As tipologias concretas de dados pessoais objeto de tratamento por parte da PDTs.pt, encontram-se diretamente relacionados com as suas atividades e são muito diversas, aqui podendo contar-se nome, número de identificação civil, NIF, morada, correio eletrónico, número de telefone e de telemóvel, categoria profissional ou cargo desempenhado, serviço onde se desempenha funções, entre outros.</p>

            <h2>Outras definições relevantes</h2>
            ...
            <h2>Fundamento e Finalidade do tratamento de dados pessoais</h2>
            <p>A PDTs.pt procede à recolha e tratamento de dados pessoais para a prossecução das suas atividades, designadamente para efeitos de:</p>
            ...
            <h2>Partilha e divulgação dos dados</h2>
            <p>A PDTs.pt só partilha dados pessoais com terceiros se tiver fundamento legal para o efeito, como seja o consentimento do titular dos dados, o cumprimento de obrigações legais que lhe estão cometidas, ou o exercício de funções de interesse púbico.</p>

            <p>Fora dessas situações, não transmitimos, vendemos ou trocamos os seus dados pessoais com terceiros, sendo que os mesmos serão apenas armazenados e tratados dentro da infraestrutura tecnológica da PDTs.pt.</p>

            <h2>Conservação dos dados</h2>
            <p>A PDTs.pt apenas conserva os dados pessoais recolhidos e tratados pelo período de tempo previsto na legislação aplicável ou, não havendo previsão legal, pelo hiato temporal estritamente necessário à observância das atividades desta Associação, que presidiram à sua recolha.</p>

            <h2>Segurança dos dados pessoais</h2>
            <p>A PDTs.pt assume o compromisso de garantir a segurança e proteção dos dados pessoais que recolhe, tendo, para o efeito, adotado uma série de medidas técnicas e organizativas. </p>
            ...
            <h2>Direitos dos utilizadores em relação aos dados</h2>
            <p>O titular dos dados tem o direito de solicitar à PDTs.pt o acesso aos dados pessoais que lhe digam respeito, à sua retificação ou ao seu apagamento, à observância da limitação do tratamento dos seus dados e à portabilidade dos dados quando tecnicamente possível. O titular dos dados pode opor-se ao tratamento ou retirar, em qualquer momento, o consentimento previamente dado.</p>

            <h2>Como pode exercer os direitos</h2>
            <p>Para exercer os seus direitos, o titular dos dados deve enviar um pedido para o Encarregado da Proteção de Dados para o seguinte contacto: pdts.portugal@gmail.com</p>

            <h2>Alterações à Política de Privacidade</h2>
            <p>A Política de Privacidade e de Proteção de Dados Pessoais ora definida, pode ser alterada periodicamente sem necessidade de prévio consentimento do titular dos dados. Quaisquer alterações significativas serão comunicadas com o mesmo grau de publicidade que presidiu à divulgação da sua versão inicial.
                    
            <p style="font-size: 12px;">Disclaimer: todas as imagens foram descarregadas de Freepik.com</p>
